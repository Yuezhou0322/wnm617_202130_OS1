...
[
  '{{repeat(50)}}',
  {
    ...
    type: '{{random("hamster","GuineaPig","chinchilla")}}',
    color: function(tags) {
      var colors = {
        hamster:["brown","black","white","grey"],
        GuineaPig:["brown","black","white","grey"],
        chinchilla:["brown","black","white","grey"]
      };
...
[
  '{{repeat(250)}}',
  {
    ...
    lat: '{{floating(37.800807, 37.606647)}}',
    lng: '{{floating(-122.375112, -122.190145)}}',
